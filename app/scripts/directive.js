   ...
   .directive('barsChart1', function () {
    return {
         ...
         link: function (scope, element, attrs) 
            {
             var data = [
     { name:"India",      income:15300, life: 87, pop:5084, color: "green"},
     { name:"Nepal",      income:36730, life: 87, pop:5084, color: "red" },
     { name:"Brazil",     income:58000, life: 87, pop:5084, color: "yellow" },
     { name:"Hongkong",   income:78300, life: 87, pop:5084, color: "pink" },
     { name:"Italy",      income:98300, life: 87, pop:5084, color: "blue" },
     { name:"Bangladesh", income:110700, life: 87, pop:5084, color: "grey" }
  ];
